  ...
  Future<void> fetchCategories() async {
    ...
    try {
      ...
      final List<dynamic> data = json.decode(response.body)[
          "products"]; // name must be same from api otherwise you got error
...
// In our api there is different category items in today video we have display the same category items in same section.
